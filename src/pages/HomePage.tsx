...
const steps = [
  ...
  {
    icon: FaChartLine,
    title: 'أدخل مجموع علاماتك',
    desc: 'أدخل مجموع علاماتك وسنة التخرج واختر نوع الجامعة التي تفضلها.',
  },
  {
    icon: FaCompass,
    title: 'اكتشف تخصصك',
      ...
      <section className="relative overflow-hidden bg-primary-deep text-white">
        ...
        <div className="container-app relative py-20 sm:py-28 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              أدخل نوع شهادتك ومجموع علاماتك، وسنعرض لك التخصصات والجامعات التي يحق لك التقديم إليها وفق
